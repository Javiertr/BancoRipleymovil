...
public class ErrorIngreso {
		...
		filename = "IMG1_RUTEI.png";
		FileHandler.copy(srcFile, new File(filename));
		
		
		
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View[2]/android.view.View[2]/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.widget.EditText")).sendKeys("4321");
		System.out.println("Se ingresa Password 4321");
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
				augmentedDriver = new Augmenter().augment(driver);
		srcFile = ((TakesScreenshot) augmentedDriver).getScreenshotAs(OutputType.FILE);
		filename = "IMG2_PassEI.png";
		FileHandler.copy(srcFile, new File(filename));
